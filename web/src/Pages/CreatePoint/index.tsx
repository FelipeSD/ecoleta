...
import { Link, useHistory } from 'react-router-dom' // conceito de SPA
...
const CreatePoint = () => {
    ...
    useEffect(() => {
        api.get('items').then((response)=>{
            ...
            // 1: função que irá executar
            //2: quando a função ira executar
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    ...
                    <Map center={[ -21.1331076,-47.9713124 ]} zoom={15} onClick={handleMapClick}>
                        <TileLayer
